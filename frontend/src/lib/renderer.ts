const sharedDocumentHead = `
  ...
  <style>
    ...
    /* 
      ...
      Because this content runs inside an auto-resizing iframe, 
      viewport units (vh) or h-screen will lock it to the initial 
      small height of the iframe, clipping the content and preventing true measurement.
    */
    .h-screen, .h-\\[100vh\\], .min-h-screen, .min-h-\\[100vh\\] {
